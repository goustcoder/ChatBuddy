  ...
  return (
    <section className="relative bg-gradient-to-r from-black to-purple-900 text-white py-20 px-10 flex flex-col md:flex-row items-center md:items-start  gap-10">
      <div className="md:w-1/2 text-center md:text-left">
        ...
        Your AI chat buddy is here to keep you company! Smart, fun, and always ready to chat—whether you need a friend, a brainstorming partner, or just someone to talk to. One message away, and your perfect chat companion is here!        </p>
